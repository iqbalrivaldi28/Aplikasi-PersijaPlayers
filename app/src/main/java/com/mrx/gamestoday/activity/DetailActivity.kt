...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        favButton.setOnClickListener {
            if (!fav) {
                Toast.makeText(this, "Kamu Memiih Pemain Ini", Toast.LENGTH_SHORT).show()
                favButton.setImageResource(R.drawable.ic_baseline_thumb_up_24)
                fav = true
            } else {
                Toast.makeText(this, "Pilihan dibatalkan", Toast.LENGTH_SHORT).show()
                favButton.setImageResource(R.drawable.ic_baseline_thumb_up_24)
                fav = false
            }
        }
        ...
        shareButton.setOnClickListener {
            ...
            goShare.putExtra(Intent.EXTRA_TEXT, "Pemain Persija Pilihan Saya: $charLink")
